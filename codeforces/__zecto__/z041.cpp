//  URL : https://codeforces.com/contest/1282/problem/A
//  Problem tags : 
//  Date : 24/12/2019
...
signed main()
{
    ...
    FOR_EACH_TESTCASE
    {
        ...
        if(a>=(c-r) && a<=(c+r) && b>=(c+r)) x=b-(c+r);
        else if(a>=(c+r)) x=(b-a);
        else if(b<=(c-r)) x=(b-a);
        else if(a<=(c-r) && b<=(c+r) && b>=(c-r)) x=(c-r)-a;
        else if(a>=(c-r) && b<=(c+r)) x=0;
        else if(a<=(c-r) && b>=(c+r)) x = (b-a)-2*r;
